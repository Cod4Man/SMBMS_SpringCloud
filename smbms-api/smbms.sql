...
-- ----------------------------
INSERT INTO `smbms_bill` VALUES (1, 'BILL2016_001', '洗发水、护发素、植发剂', '日用品-洗发、护发', '瓶', 500.00, 25000.00, 1, NULL, '2019-06-12 16:04:05', 42, '2019-04-03 17:05:11', 10);
...
INSERT INTO `smbms_bill` VALUES (19, 'BILL2016_019', '哇哈哈2019', '饮料', '瓶', 2000.00, 4000.00, 1, 1, '2015-11-24 15:12:03', 42, '2019-04-03 16:59:58', 3);
INSERT INTO `smbms_bill` VALUES (20, 'BILL2016_020', '喜多多', '喝的', '罐', 1.00, 12.00, 1, 1, '2019-03-28 11:45:54', NULL, NULL, 14);
INSERT INTO `smbms_bill` VALUES (21, 'BILL2016_020', '喜多多', '喝的', '罐', 1.00, 12.00, 1, 1, '2019-03-28 11:46:46', NULL, NULL, 14);
INSERT INTO `smbms_bill` VALUES (23, 'BILL2016_020', '喜多多', '喝的', '罐', 1.00, 12.00, 2, 1, '2019-03-28 11:49:22', NULL, NULL, 9);
INSERT INTO `smbms_bill` VALUES (27, 'BILL2016_020', '嘻嘻嘻', '喝的', '罐', 1.00, 12.00, 1, 1, '2019-03-29 15:24:02', NULL, NULL, 15);
...
-- ----------------------------
INSERT INTO `smbms_provider` VALUES (1, 'BJ_GYS001', '北京三木堂商贸有限公司', '长期合作伙伴，主营产品:茅台、五粮液、郎酒、酒鬼酒、泸州老窖、赖茅酒、法国红酒等', '张国强', '13566666666', '北京市丰台区育芳园北路', '010-58858787', 1, '2013-03-21 16:52:07', '2019-03-29 15:21:35', 1);
...
INSERT INTO `smbms_provider` VALUES (16, 'casad', '名称', '描述', '联系人', '18311111111', '练习地址', '传真', 42, '2019-04-03 15:54:34', '2019-04-03 16:00:22', 42);
INSERT INTO `smbms_provider` VALUES (17, 'casad', '测试2', '啊2', '测试2', '18311111111', '啊2', '啊2', 42, '2019-04-03 15:54:50', NULL, NULL);
...
INSERT INTO `smbms_user` VALUES (13, 'dengchao', '邓超', '0000000', 1, '1981-11-04', '13689674534', '北京市海淀区北航家属院10号楼', 3, 1, '2016-07-11 08:02:47', 1, '2019-03-28 20:56:48');
...
INSERT INTO `smbms_user` VALUES (40, 'admin3', 'admin', '1111111', 2, '2017-01-01', '18359100900', '厦门', 1, 1, '2019-03-30 14:05:10', 42, '2019-04-03 15:40:09');
INSERT INTO `smbms_user` VALUES (42, 'admin', 'adminMaster', '1111111', 1, '2009-03-09', '18359100900', '厦门思明区', 1, 39, '2019-04-03 15:10:16', 42, '2019-05-25 10:42:50');

-- ----------------------------
-- Table structure for testmasternslave
-- ----------------------------
DROP TABLE IF EXISTS `testmasternslave`;
CREATE TABLE `testmasternslave`  (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
